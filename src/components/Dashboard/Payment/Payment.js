...
const Payment = () => {
    ...
    const [orderData, setOrderData] = useSingleOrder()

    const checkOutHandle = () => {
        localStorage.setItem('price', orderData.price)
                ...
                <div class="flex shadow-md my-5">
                        ...
                        <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                            <div class="flex w-2/5">
                                ...
                                <div class="flex flex-col justify-between ml-4 flex-grow">
                                    <span class="font-bold text-sm">{orderData.displayName}</span>
                            ...
                            <span class="text-center w-1/5 font-semibold text-sm">$ {orderData.price}</span>
                            <span class="text-center w-1/5 font-semibold text-sm">$ {orderData.price}</span>
                        </div>
                    ...
                    <div id="summary" class="w-1/4 px-8 py-10">
                        ...
                        <div class="flex justify-between mt-10 mb-5">
                            ...
                            <span class="font-semibold text-sm">{orderData.price} $</span>
                        </div>
                        <div>
